...
use External_Centers, only: Dxyz, AMP_Center, EF_Centers, DMS_Centers, KVectors, nDMS, nEF, nOrdEF, nOrd_XF, nWel, OAM_Center, &
                            OMQ_Center, Wel_Info, XF
...
integer(kind=iwp) :: i, i2, i3, iAddr, iAtom_Number, iB, iC, iChO, iChO1, iChO2, iChOx, iChOxx, iChOxy, iChOxz, iChOy, iChOyx, &
                     ...
                     iSyXYZ, iTemp, iTol, iWel, ix, ixyz, iy, iz, jx, jxyz, jy, jz, k, kCnttpPAM_, lOper, LuTmp, mCnt, mComp, &
